function checkEmail(){
	...
	if(!email || email === ""){
		alert("please fill email.... email is blank");
		return;
	}

let queryURL ="http://localhost:30000/" + email;
...
if (result.message){
	...
	msgDiv.innerHTML ='<div class="alert-success alert-dismissible" role="alert">\
						...
						<h2 <strong>.....CONGRATULATIONS!</strong> YOUR EMAIL ADDRESS IS NEVER HACKED.....</h2>\
						</div>';
}
else {
	msgDiv.innerHTML='<div class="alert-success alert-dismissible" role="alert">\
	                    <button type="button" class ="close" data-dismiss="alert"aria-label="close"><span aria-hidden="true">&times;</span></button>\
						<h2 <strong> YOUR EMAIL ADDRESS IS HACKED!.... BETTER CHECK YOURSELF.</strong> </h2>\
						</div>';
resdiv.innerHTML ="";
var i =0;
